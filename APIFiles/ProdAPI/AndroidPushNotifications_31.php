...
//';
	...
	public function Send($data, $reg_id) {
		...
		$fcmFields = array(
			'to' => $singleID,//"dO3b27Atpuo:APA91bESLyDN9QwiGt_JQGY1a_e48k-7o_hjsBtAcqS8v0FwI2mEiZ_TQk7lMwwKKSELV5W_X3YNw3bq-rWVLEVmCBLM-9OazQ3sv06gA1Z7gEJvCR_nk4oruZBdGIFd2eF4cwAbPLJD",
        	'priority' => 'high',
			'notification' => $fcmMsg
		);
