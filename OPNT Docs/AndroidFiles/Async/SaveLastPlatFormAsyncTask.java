...
public class SaveLastPlatFormAsyncTask extends AsyncTask<String, Void, String> {
    Context mContext;
    Progress mprogress;
    Boolean progress;
    String response = "";
    ...
    public SaveLastPlatFormAsyncTask(Context context, CommonInterface commonInterface) {
    ...
    protected String doInBackground(String... params) {
        try {
            ...
            jsonObject.put("device_uuid", params[0]);
            jsonObject.put("platform",Constants.PLATFORM_VALUE);
            response = new HttpRequest(mContext).HttpPost(jsonObject, BuildConfig.SERVER_URL + Constants.app_save_last_platform_url);
