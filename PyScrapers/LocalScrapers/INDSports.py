...
with open(f"C:/Users/atambe/PycharmProjects/ASTNewsConsol/INDSports{today.strftime('%d-%m-%Y')}.sql", 'w', encoding='utf-8') as f:
    for i in range(len(url_ls)):
        ...
        try:
            ...
            print("Exception occurred in INDSPOrts:",e)
            continue
