...
today = date.today()
## url
url1 = 'https://guardian.ng/feed/'
url2 = 'https://rss.punchng.com/v1/category/business'
url3 = 'https://www.premiumtimesng.com/feed'
url4 = ''
url5 = ''
url6 = ''
url7 = ''
...
scrape_src = ['GRD/POL', 'PUNCH/BIZ', 'PMTNG/POL', 'NDTV/TOP', 'MINT/POL', 'ESPN/NCF', 'FOX/NASCAR', 'CBS/GOLF', 'YAHOO/POLITICS', 'SILLU/POLITICS']
scrape_top = ['POLITICS', 'BUSINESS', 'POLITICS', 'POLITICS', 'POLITICS', 'POLITICS', 'POLITICS', 'POLITICS', 'POLITICS', 'POLITICS']
coun_code = ['NGA', 'NGA', 'NGA', 'IND', 'IND', 'IND', 'IND', 'IND', 'IND', 'IND']
tag1 = ['POLITICS', 'BUSINESS', 'POLITICS', 'POLITICS', 'POLITICS', 'POLITICS', 'POLITICS', 'POLITICS', 'POLITICS', 'POLITICS']
tag2 = ['POLITICS', 'BUSINESS', 'POLITICS', 'POLITICS', 'POLITICS', 'POLITICS', 'POLITICS', 'POLITICS', 'POLITICS', 'POLITICS']
tag3 = ['POLITICS', 'BUSINESS', 'POLITICS', 'POLITICS', 'POLITICS', 'POLITICS', 'POLITICS', 'POLITICS', 'POLITICS', 'POLITICS']
ntag = ['PYSCRAPE', 'PYSCRAPE', 'PYSCRAPE', 'PYSCRAPE', 'PYSCRAPE', 'PYSCRAPE', 'PYSCRAPE', 'PYSCRAPE', 'PYSCRAPE', 'PYSCRAPE']

with open(f"NGAALL{today.strftime('%d-%m-%Y')}.sql", 'w', encoding='utf-8') as f:
