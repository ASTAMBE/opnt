...
SELECT MONTH(CREATION_DATE) MTH,  COUNT(1) FROM OPN_USERLIST WHERE USER_TYPE = 'USER' AND CREATION_DATE > CURRENT_DATE - INTERVAL 100 DAY GROUP BY MONTH(CREATION_DATE) ORDER BY 1;
SELECT MONTH(CREATION_DATE) MTH, TRUE_COUNTRY_CODE,  COUNT(1) FROM OPN_USERLIST WHERE USER_TYPE = 'USER' 
AND CREATION_DATE > CURRENT_DATE - INTERVAL 100 DAY GROUP BY MONTH(CREATION_DATE), TRUE_COUNTRY_CODE ORDER BY 1;
