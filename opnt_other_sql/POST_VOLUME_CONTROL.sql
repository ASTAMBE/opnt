...
AND P.POST_DATETIME > CURRENT_DATE() - INTERVAL 3 DAY GROUP BY  P.TOPICID, P.POSTOR_COUNTRY_CODE
ORDER BY 1, 2;
...
WHERE C.USERID = U.USERID AND C.TOPICID = T.TOPICID AND C.KEYID IN (105108) AND U.COUNTRY_CODE = 'GGG'
