...
CALL STP_REMAINDER('SPORTS', 2, 105654, 'USA', 3, 60) ;
...
CALL STP_REMAINDER('ENT', 5, 105655, 'IND', 3, 15) ;
CALL STP_REMAINDER('CELEB', 10, 105089, 'IND', 3, CELEBIND) ;
CALL STP_REMAINDER('ENT', 5, 105655, 'GGG', 3, 7) ;
CALL STP_REMAINDER('CELEB', 10, 105089, 'GGG', 3, 10) ;
