...
AND P.POST_DATETIME > CURRENT_DATE() - INTERVAL 30 DAY GROUP BY P.STP_PROC_NAME, P.TOPICID, P.POSTOR_COUNTRY_CODE
ORDER BY 2, 3;
...
, SUM(CASE WHEN U.BOT_FLAG <> 'Y' THEN 1 ELSE 0 END) REALPOSTS
FROM OPN_POSTS P, OPN_USERLIST U WHERE P.POST_BY_USERID = U.USERID 
AND P.POST_DATETIME > CURRENT_DATE() - INTERVAL 30 DAY GROUP BY P.TOPICID, P.POSTOR_COUNTRY_CODE
ORDER BY 1, 2;
