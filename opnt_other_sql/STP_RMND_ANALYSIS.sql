...
SELECT * FROM OPN_POSTS WHERE TOPICID = 2 AND STP_PROC_NAME = 'STP_REMAINDER' AND POSTOR_COUNTRY_CODE = 'USA' AND POST_DATETIME > CURRENT_DATE() - INTERVAL 2 DAY ORDER BY POST_ID DESC ;