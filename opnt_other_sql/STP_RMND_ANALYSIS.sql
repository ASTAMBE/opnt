...
SELECT * FROM WSR_CONVERTED WHERE NEWS_URL = 'https://www.nationalreview.com/2023/08/biden-says-in-practice-hes-declared-a-national-climate-emergency' ;
SELECT * FROM WSR_UNTAGGED WHERE ROW_ID > 1700000 AND NEWS_URL = 'https://www.nationalreview.com/2023/08/biden-says-in-practice-hes-declared-a-national-climate-emergency' ;
SELECT * FROM WSR_UNTAGGED ORDER BY ROW_ID DESC LIMIT 100 ;