...
SELECT TOPICID, POSTOR_COUNTRY_CODE, COUNT(1) FROM OPN_POSTS WHERE POST_ID > 1235000 -- AND STP_PROC_NAME = 'SCRAPE_TO_DISC' 
AND POST_DATETIME > CURRENT_DATE() - INTERVAL 2 DAY GROUP BY TOPICID, POSTOR_COUNTRY_CODE ORDER BY 1,2 ;
