...
SELECT * FROM WEB_SCRAPE_RAW_L WHERE SCRAPE_TOPIC = 'SCIENCE' AND COUNTRY_CODE = 'GGG' ORDER BY ROW_ID DESC ;
...
SELECT STP_PROC_NAME, COUNT(1) FROM OPN_POSTS WHERE POST_ID > 1235000  GROUP BY STP_PROC_NAME ;
SELECT * FROM OPN_P_KW ORDER BY KEYID DESC ;
SELECT * FROM WSR_CONVERTED ORDER BY ROW_ID DESC LIMIT 100 ;

CALL callSTDbyIntCcode(3, 'GGG', 'SCIENCE' , 30) ;
