...
01/30/2025 AST: Adding POSTOR_TCC to the trigger

07/08/2025 AST: Adding POST_URL to the trigger
 
 */
 

 IF NEW.EMBEDDED_FLAG = 'N' THEN 
INSERT INTO OPN_POSTS(POST_ID, TOPICID, POST_DATETIME, POST_UPDATE_DTM, POSTOR_COUNTRY_CODE, POSTOR_TCC
, POST_BY_USERID, POST_CONTENT, POST_URL, DEMO_POST_FLAG, EMBEDDED_CONTENT, EMBEDDED_FLAG
...
VALUES(NEW.POST_ID, NEW.TOPICID, NEW.POST_DATETIME, NEW.POST_DATETIME, NEW.POSTOR_COUNTRY_CODE, NEW.POSTOR_TCC
, NEW.POST_BY_USERID, NEW.POST_CONTENT, NEW.POST_URL, NEW.DEMO_POST_FLAG, NULL, 'N'
...
, TAG1_KEYID, STP_PROC_NAME, MEDIA_CONTENT, MEDIA_FLAG, SCRAPE_SOURCE, SCRAPE_TYPE)
VALUES(NEW.POST_ID, NEW.TOPICID, NEW.POST_DATETIME, NEW.POST_DATETIME, NEW.POSTOR_COUNTRY_CODE, NEW.POSTOR_TCC
, NEW.POST_BY_USERID, NEW.POST_CONTENT, NEW.POST_URL, NEW.DEMO_POST_FLAG, NEW.EMBEDDED_CONTENT, 'Y'
