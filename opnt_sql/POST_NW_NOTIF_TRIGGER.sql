...
INSERT INTO OPN_PUSH_LAUNCH_1(USERID, USER_UUID, APP_TOKEN, USER_PLATFORM, PUSH_TYPE
...
INSERT IGNORE INTO OPN_PUSH_LAUNCH_2(USERID, USER_UUID, APP_TOKEN, USER_PLATFORM, PUSH_TYPE
, PUSH_COUNT, PUSH_TOPIC, SOURCE_ID, POST_EXCERPT, PUSH_TITLE)
SELECT U.USERID, U.USER_UUID, U.IDENTIFIER_TOKEN, U.LAST_USED_PLATFORM, 'POST'
, 1 , POSTTOPIC, NEW.TOPICID, POST_EXCRPT, 'New discussion started in'
FROM OPN_USERLIST U, ( SELECT DISTINCT B.USERID FROM
