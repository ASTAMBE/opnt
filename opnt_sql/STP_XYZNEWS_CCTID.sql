...
DELIMITER //
DROP PROCEDURE IF EXISTS STP_XYZNEWS_CCTID //
CREATE PROCEDURE STP_XYZNEWS_CCTID(ccode varchar(5), tid int)
THISPROC: BEGIN

/* 

	09/26/2021 AST: STILL WIP
    This is being conceived as the proc that will be used when we roll out CC and TID specific apps

*/

DECLARE POSTCOUNT, UNTAGCOUNT INT ;

CASE WHEN CCODE = 'USA' THEN
