...
/* 10/15/2020 AST: Confirmed  
    ...
    09/29/2024 AST: By mistake the first INSERT into WSD was using SELECT FROM WSRL - now fixed to WSR
*/
...
FROM WEB_SCRAPE_RAW W,  (SELECT NEWS_URL, MAX(ROW_ID) MAXID FROM WEB_SCRAPE_RAW GROUP BY NEWS_URL) G1
...
INSERT INTO WEB_SCRAPE_RAW(SCRAPE_DATE, NEWS_DTM_RAW, NEWS_DATE, SCRAPE_SOURCE, SCRAPE_TOPIC, NEWS_URL, NEWS_PIC_URL, NEWS_HEADLINE, NEWS_EXCERPT
, MOVED_TO_POST_FLAG, COUNTRY_CODE, SCRAPE_TAG1, SCRAPE_TAG2, SCRAPE_TAG3, TAG_DONE_FLAG) 
