-- bringCommentCountALL

DELIMITER //
DROP FUNCTION IF EXISTS bringCommentCountALL //
CREATE FUNCTION bringCommentCountALL(UUID VARCHAR(45),  postID INT) RETURNS INT
BEGIN
...
WHERE P.COMMENT_BY_USERID = NW1.IN_NW_UID 
AND P.TOPICID = NW1.TOPICID
