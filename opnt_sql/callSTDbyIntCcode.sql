...
CREATE DEFINER=`root`@`%` PROCEDURE `callSTDbyIntCcode`(tid INT, ccode varchar(5), scr_tpc varchar(15) , howMany INT)
thisproc:BEGIN
 ...
 */
  ...
  DECLARE CURSOR_I CURSOR FOR SELECT ROW_ID, SCRAPE_SOURCE FROM WEB_SCRAPE_RAW_L 
