...
DELIMITER //
CREATE PROCEDURE copyUserCarts(uuidFrom varchar(45), uuidTo varchar(45), postID INT, uType varchar(5))
THISPROC: BEGIN
...
WHEN postID <> 0 THEN 
SET TIDTO = IFNULL((SELECT OPR1.TOPICID FROM OPN_POSTS_RAW OPR1 WHERE OPR1.POST_ID = postID), 0) ;
