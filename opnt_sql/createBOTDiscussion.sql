...
DECLARE UNAME,fromTable, COMMENTER1, COMMENTER2 VARCHAR(30) ;
DECLARE UUID VARCHAR(50) ;
DECLARE SUSPUSER VARCHAR(5) ;
...
SELECT NEWS_URL, NEWS_HEADLINE, NEWS_EXCERPT into URL, newsTitle, newsExcrpt FROM WEB_SCRAPE_RAW_L WHERE ROW_ID = source_row_id ;
...
,COMMENT_DTM,EMBEDDED_CONTENT,EMBEDDED_FLAG, COMMENT_TYPE, MEDIA_CONTENT, MEDIA_FLAG) 
VALUES
(POSTID, orig_uid, tid, 1, newsExcrpt, CBYUID, COMMENTER
