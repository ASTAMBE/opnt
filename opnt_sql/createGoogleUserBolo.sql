-- createGoogleUserBolo

 DELIMITER //
DROP PROCEDURE IF EXISTS createGoogleUserBolo //
CREATE PROCEDURE createGoogleUserBolo(username varchar(30), country_code varchar(5), fname varchar(150)
...
VALUES('createGoogleUserBolo', NOW(), 'USERNAME', username) ;
