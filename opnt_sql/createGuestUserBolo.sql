...
DROP PROCEDURE IF EXISTS `createGuestUserBolo`;
DELIMITER //
CREATE   PROCEDURE `createGuestUserBolo`(devicename varchar(600), country_code varchar(5), device_serial VARCHAR(40))
BEGIN
