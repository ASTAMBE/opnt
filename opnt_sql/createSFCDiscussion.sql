...
/* THE BELOW PORTION - DID NOT HAVE URL_TILE IN THE INSERT - NOW IT DOES */

INSERT INTO OPN_POSTS_RAW(TOPICID, POST_DATETIME, POST_BY_USERID, POST_CONTENT, URL_TITLE, DEMO_POST_FLAG
,EMBEDDED_CONTENT,EMBEDDED_FLAG, POSTOR_COUNTRY_CODE,MEDIA_CONTENT,MEDIA_FLAG, STP_PROC_NAME)
VALUES (tid, ndtm, orig_uid, URL, newsTitle, 'N', '', 'N', country_code, '', 'N', 'STD_ONLY_DISC');
