...
DELIMITER //
CREATE PROCEDURE getDiscussionsANTI(userid varchar(45), topicid INT , fromindex INT, toindex INT)
THISPROC: BEGIN
...
, CASE WHEN BK2.POST_ID IS NOT NULL THEN 'B' ELSE NULL END BOOKMARK_FLAG
FROM (
...
INNER JOIN (SELECT * FROM OPN_USERLIST WHERE BOT_FLAG = 'N'
) OU
