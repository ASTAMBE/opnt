-- networkBolo
 ...
 DELIMITER //
DROP PROCEDURE IF EXISTS networkBolo //
CREATE PROCEDURE networkBolo(UUID varchar(45), topicid INT, fromIndex INT, toIndex INT)
BEGIN
...
VALUES(UNAME, orig_uid, UUID, NOW(), 'networkBolo', CONCAT(topicid, '-',toindex));
