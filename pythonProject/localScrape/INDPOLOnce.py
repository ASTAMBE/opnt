...
#with open(f"/var/www/html/scraper/INDALL/INDPolOnce{today.strftime('%d-%m-%Y')}.sql", 'w', encoding='utf-8') as f:
with open(f"c:/AST/scrapefiles/INDPolOnce{today.strftime('%d-%m-%Y')}.sql", 'w', encoding='utf-8') as f:
